...
#     tokens_np_uint16 = tokens_np.astype(np.uint16) # unit16 to save some space
...
# nprocs = max(1, os.cpu_count()) # max(1, os.cpu_count()//2)
# with mp.Pool(nprocs) as pool:
#     shard_index = start_shard
...
#     token_count = 0
#     progress_bar = None
#     for tokens in pool.imap(tokenize, fw, chunksize=256): # init 16
